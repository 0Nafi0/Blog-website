...
def register():
    ...
    if form.validate_on_submit():
        ...
        hashed_password = generate_password_hash(password=form.password.data, method="pbkdf2", salt_length=8)
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            flash("You entered wrong email or you might haven't registered yet.")
            return redirect(url_for("login"))
